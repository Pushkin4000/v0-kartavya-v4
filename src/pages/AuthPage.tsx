...
export default function AuthPage() {
  ...
  return (
    <PageLayout className="bg-gray-50" containerClassName="max-w-lg py-12">
      <div className="flex justify-center mb-6">
        <Link to="/" className="flex items-center">
          <Package className="h-10 w-10 text-kartavya-primary" strokeWidth={2} />
          <span className="ml-2 font-heading font-bold text-2xl text-kartavya-dark">Kartavya</span>
        </Link>
      </div>
        ...
        <TabsContent value="register">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Join Kartavya to start sharing or receiving food resources.</CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...registerForm}>
                <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {selectedUserType === "provider" ? "Business / Restaurant Name" : "Organization Name"}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={
                              selectedUserType === "provider" ? "Enter business name" : "Enter organization name"
                            }
                            {...field}
                          />
                        </FormControl>
