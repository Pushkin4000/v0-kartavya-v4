...
import type { Order, UserType, OrderStatus } from "@/lib/types"
  ...
  return (
    <Card>
      <CardContent className="p-4">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500">{userType === "provider" ? order.ngoName : "Your order"}</p>
          </div>
      ...
      <CardFooter className="p-4 pt-0 flex justify-between">
        ...
        {canChangeStatus && (
          <Button onClick={handleStatusChange} className="w-full ml-2">
            {getNextStatusLabel()}
          </Button>
        )}
      </CardFooter>
